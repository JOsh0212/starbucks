...
new Swiper('.promotion .swiper',{
  ...
  centeredSlides:true,  //1번 슬라이드가 가운데에서 시작하도록
  loop:true,
  autoplay:{
    delay:5000 //5초
  },
...
const promotionToggleBtnIcon = document.querySelector('.toggle-promotion .material-icons');
...
function floatingObject(selector,delay,size){
  gsap.to(selector,random(1.5,2.5),{ //gsap.to(요소, 지속시간, 옵션);
      y:size,
      repeat:-1,
      yoyo:true,
